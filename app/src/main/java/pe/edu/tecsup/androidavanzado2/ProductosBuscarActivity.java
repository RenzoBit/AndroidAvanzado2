    ...
    private class HttpREST extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            try {
                ...
                HttpRequest httpRequest = HttpRequest.get("http://renzovilela.tk/rest/productos/" + criterioBusqueda);
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ArrayAdapter<String> adaptador = new ArrayAdapter<String>(ProductosBuscarActivity.this, android.R.layout.simple_list_item_1, matriz);
